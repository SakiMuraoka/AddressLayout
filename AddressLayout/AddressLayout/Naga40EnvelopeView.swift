...
struct Naga40EnvelopeView: View {
...
struct Naga40EnvelopeView_Previews: PreviewProvider {
    static var previews: some View {
         ForEach(["iPhone 11"], id: \.self) { deviceName in
            Naga40EnvelopeView(envelopeTypeViewModel: EnvelopeTypeViewModel.init(selectedId: 2))
               }
    }
}
